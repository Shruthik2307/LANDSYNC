...
class ModelRegistry:
    ...
    def info(self) -> dict:
        ...
        return {
            ...
            "training_date": a.get("training_date") or a.get("trained_at"),
            "training_sample_count": a.get("training_sample_count") or a.get("training_samples"),
            "verified_label_count": a.get("verified_label_count") or a.get("total_samples"),
            "verified_sample_count": a.get("verified_sample_count") or a.get("total_samples"),
            "class_distribution": a.get("class_distribution") or a.get("training_class_distribution"),
